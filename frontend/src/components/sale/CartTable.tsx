		...
		<div className="border-t border-neutral-200 px-6 py-4">
			...
			<div className="overflow-hidden rounded-lg bg-neutral-50">
				<table className="w-full">
					<thead>
						<tr className="border-b border-neutral-200 text-left text-xs font-semibold tracking-wider text-neutral-500 uppercase">
							<th className="px-3 py-2">항목</th>
							<th className="w-28 px-3 py-2">이벤트</th>
							<th className="px-3 py-2">결제수단</th>
							<th className="w-20 px-3 py-2 text-right">할인</th>
							<th className="w-24 px-3 py-2 text-right">금액</th>
								...
								>
									...
									<td className="px-3 py-3">
										<div className="flex items-center gap-2">
											...
											/>
											<span className="max-w-[100px] truncate text-sm text-neutral-700">
												{item.name}
											</span>
									...
									<td className="px-3 py-3">
										{isTopup ? (
											...
											<select
												...
												className="w-full rounded border border-neutral-200 bg-white px-2 py-1 text-xs focus:border-[#0073ea] focus:outline-none"
											>
									...
									<td className="px-3 py-3 text-right">
										{item.discountAmount > 0 ? (
											<span className="text-xs font-medium text-[#e2445c]">
									...
									<td className="px-3 py-3 text-right">
										{item.paymentMethod === "membership" ? (
											<span className="text-xs font-semibold text-[#e2445c]">1회</span>
										) : (
